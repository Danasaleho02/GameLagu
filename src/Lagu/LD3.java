...
public class LD3 extends javax.swing.JFrame {

    public static int indexScore;

    boolean cek = false;
    public static int nilainya = 0;
    String LaguDaerah1[] = {"Suwe Ora Jamu"};
    ...
    private void initComponents() {
        ...
        lagu3.setText("Lagu 3");
        lagu3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lagu3ActionPerformed(evt);
            }
        });
        getContentPane().add(lagu3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, -1, -1));
...
//        this.hasil.setText(null);
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
        ...
        if (jawab.isEmpty()) {
            ...
            this.nilai.setText("Nilai : " + "30");
            JOptionPane.showMessageDialog(this, "Nilai Kamu adalah 30", "BENAR", JOptionPane.INFORMATION_MESSAGE);
...
//            skor -= 5;
    ...
    private void lagu3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lagu3ActionPerformed
        ...
        try {
            ...
            String uri = new File("src\\music\\D3.mp3").toURI().toString();
    ...
    private javax.swing.JButton lagu3;
