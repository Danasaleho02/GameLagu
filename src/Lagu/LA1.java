...
public class LA1 extends javax.swing.JFrame {
...
//    int nyawa1 = 3;
    ...
    private void initComponents() {
        ...
        lagu1.setText("Lagu 1");
        lagu1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                lagu1MouseReleased(evt);
            }
        });
        ...
        getContentPane().add(lagu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 70, -1));
        ...
        getContentPane().add(btnpause, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 320, -1, -1));
...
//        this.hasil.setText(null);
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
        ...
        if (jawab.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Nilai Kamu adalah 10", "BENAR", JOptionPane.INFORMATION_MESSAGE);
...
//            skor -= 5;
    ...
    private void lagu1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lagu1MouseReleased

    }//GEN-LAST:event_lagu1MouseReleased
    ...
    private void lagu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lagu1ActionPerformed
        ...
        try {
            ...
            String uri = new File("src\\music\\A1.mp3").toURI().toString();
...
//        AudioStream as = new AudioStream();
        try {
//            blah = new FileInputStream("src\\music\\A1.mp3");
//            audio = AudioSystem.getAudioInputStream(new File("src\\music\\A1.mp3"));

            JFXPanel j = new JFXPanel();
            String uri = new File("src\\music\\A1.mp3").toURI().toString();
//            new MediaPlayer(new Media(uri)).stop();
//            AudioPlayer.player.stop(new Media (uri));
    ...
    private javax.swing.JButton lagu1;
