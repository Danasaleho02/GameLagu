...
public class LN4 extends javax.swing.JFrame {

    public static int indexScore;

    boolean cek = false;
    public static int nilainya = 0;
    String LaguNasional1[] = {"Mengheningkan Cipta"};
    ...
    private void initComponents() {
        ...
        lagu4.setText("Lagu 4");
        lagu4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lagu4MouseClicked(evt);
            }
        });
        lagu4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lagu4ActionPerformed(evt);
            }
        });
        getContentPane().add(lagu4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 230, 70, -1));
...
//        this.hasil.setText(null);
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
        ...
        if (jawab.isEmpty()) {
        ...
        } else if (jawab.equalsIgnoreCase(LaguNasional1[0])) {
            ...
            JOptionPane.showMessageDialog(this, "Nilai Kamu adalah 40", "BENAR", JOptionPane.INFORMATION_MESSAGE);
            new game1().setVisible(true);
            dispose();
        } else {
//            skor -= 5;
    ...
    private void lagu4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lagu4ActionPerformed
//       InputStream music;
        try {
            JFXPanel j = new JFXPanel();
            String uri = new File("src\\music\\N4.mp3").toURI().toString();
...
//            AudioPlayer.player.start(audios);
    ...
    }//GEN-LAST:event_lagu4ActionPerformed

    private void lagu4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lagu4MouseClicked
        
    }//GEN-LAST:event_lagu4MouseClicked
    ...
    private javax.swing.JButton lagu4;
